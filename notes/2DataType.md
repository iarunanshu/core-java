Case Styles in Programming
    You learned about different case styles used in programming, such as:
    camelCase: myVariableName (common for variables and methods in Java)
...
Java has two floating-point primitive data types for numbers with decimal points:
